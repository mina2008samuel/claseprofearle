...
while (repetir) {
    ...
    switch (opcion) {
        ...
        case 11: {
            const pitido = (_b = prompt('¿Escucha un pitido? (si/no):')) === null || _b === void 0 ? void 0 : _b.toLowerCase();
            const discoGira = (_c = prompt('¿El disco gira? (si/no):')) === null || _c === void 0 ? void 0 : _c.toLowerCase();
        ...
        case 13: {
            const operador = ((_d = prompt('Ingrese operador (Claro, Tigo o Movistar):')) === null || _d === void 0 ? void 0 : _d.trim()) || "";
